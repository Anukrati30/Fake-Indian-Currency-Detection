...
#imgc = cv.imread("Indian currency dataset v1/test/2000__8.jpg",0)
  ...
  button1.pack(side=tk.LEFT,expand=True)
  button2 = tk.Button(root, text="200 Back", fg="red",command=Back200)
  button2.pack(side=tk.RIGHT,expand=True)
  root.mainloop()  

def rs100():
  def Front100():
    img = cv.imread("Indian currency dataset v1/test/WhatsApp Image 2022-12-01 at 9.10.48 PM.jpeg",0)
    img2 = cv.imread("Indian currency dataset v1/test/WhatsApp Image 2022-12-01 at 9.10.48 PM.jpeg")
    
    imgi=cv.imread("Indian currency dataset v1/test/WhatsApp Image 2022-12-01 at 9.10.48 PM.jpeg",0)
    imgi3=cv.imread("Indian currency dataset v1/test/WhatsApp Image 2022-12-01 at 9.10.48 PM.jpeg")

    imgi2=cv.resize(imgi,(1291,519))
 
    crop_image1= img2[50:300,400:500]
    hsv = cv.cvtColor(crop_image1, cv.COLOR_BGR2HSV)
    crop_image2=img[90:500,0:40]
    #crop_image3=img[20:100,200:350]#last
    crop_image4=img[150:250,200:250]
    #crop_image5=img[110:498,750:880]
    # crop_image6=img[430:700,1580:1700]
    # crop_image7=img[340:500,930:1150]
    # crop_image8=img[600:700,105:400]
   ...
   # plt.imshow( crop_image5),plt.show()
    ...
    # image8bit = cv.normalize(crop_image3, None, 0, 255, cv.NORM_MINMAX).astype('uint8')
    # image8biti = cv.normalize(imgi, None, 0, 255, cv.NORM_MINMAX).astype('uint8')
    # sift = cv.xfeatures2d.SIFT_create()
    # keypoints1, descriptors1 = sift.detectAndCompute(image8bit, None)
    # keypoints2, descriptors2 = sift.detectAndCompute(image8biti, None)
    ...
    # image8bit = cv.normalize(crop_image5, None, 0, 255, cv.NORM_MINMAX).astype('uint8')
    # image8biti = cv.normalize(hsv2, None, 0, 255, cv.NORM_MINMAX).astype('uint8')
    # sift = cv.xfeatures2d.SIFT_create()
    # keypoints1, descriptors1 = sift.detectAndCompute(image8bit, None)
    # keypoints2, descriptors2 = sift.detectAndCompute(image8biti, None)
    # FLAN_INDEX_KDTREE = 0
    ...
    if(len(good_matches1)==0 or len(good_matches2)==0 or len(good_matches4)==0   ):
        tk.messagebox.showinfo(title=None, message="Currency is FAKE!")
    else:
       tk.messagebox.showinfo(title=None, message="Currency is REAL!")
  ...
  def Back100():
    ...
    imgs = cv.imread("Indian currency dataset v1/test/WhatsApp Image 2022-12-01 at 9.37.57 PM.jpeg")
    img = cv.imread("Indian currency dataset v1/test/WhatsApp Image 2022-12-01 at 9.37.57 PM.jpegg",0)

    imgi=cv.imread("Indian currency dataset v1/test/WhatsApp Image 2022-12-01 at 9.37.57 PM.jpeg",0)
#imgc = cv.imread("Indian currency dataset v1/test/2000__8.jpg",0)
    imgii=cv.imread("Indian currency dataset v1/test/WhatsApp Image 2022-12-01 at 9.37.57 PM.jpeg",0)

    imgi2=cv.resize(imgi,(1291,519))
    imgii2=cv.resize(imgii,(1291,519))
    
    crop_image1=imgs[60:300,250:350]
    crop_image2=imgs[100:600,60:250]
    crop_image3=imgs[0:400,0:57]
    crop_image4=imgs[220:300,700:1000]
  ...
  label1 = tk.Label(root,text="Which Currency you want to check:")
  label1.pack(side=tk.TOP,expand=True)
  button1 = tk.Button(root, text="100 Front", fg="green",command=Front100)
  button1.pack(side=tk.LEFT,expand=True)
